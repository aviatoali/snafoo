...
export interface IconLayoutState { };

class IconLayout extends React.Component<IconLayoutProps, IconLayoutState> {
    constructor(props: IconLayoutProps) {
        super(props);
        this.state = {}
    }
            ...
            <div className="u-isHidden">
                <svg id="logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 300">
                    ...
                    <g>
                        ...
                        <path
                            d="M103.5 39.8c22.3-10.9 49.3-1.6 60.1 20.8l22.1 45.4c1 2.1 3.6 3 5.7 2s3-3.6 2-5.7l-22.1-45.4c-12.9-26.5-45-37.6-71.5-24.7-2.1 1-3 3.6-2 5.7s3.6 2.9 5.7 1.9zM195.2 115.6c-2.1 1-3 3.6-2 5.7l9.5 19.4c1 2.1 3.6 3 5.7 2s3-3.6 2-5.7l-9.5-19.4c-1.1-2.2-3.6-3-5.7-2z" />
                    </g>
                </svg>
                <svg id="icon-email" xmlns="http://www.w3.org/2000/svg" viewBox="-33 35 32 32">
                    <path fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                        d="M-31 61h28V41h-28v20zm0-20l14 10 14-10" />
                </svg>
